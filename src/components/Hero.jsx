...
export default function Hero() {
  return (
    <>
        <h5>Complete this training programme if you want to...</h5>
        <ol className='benefits-list'>
            <li>Follow a simple programme with guaranteed results</li>
        ...
        <h3>The Rules</h3>
        <p>To complete this programme, you <b>must</b> follow these 3 simple rules:</p>
        <ul className='rules-list'>
            ...
            <div className='rule-item'>
                <p><b>Weight</b></p>
                <p>Set the maximum weight that allows you to complete the set with good form</p>
            </div>
